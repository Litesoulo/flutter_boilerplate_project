...
part of '../../../../../src/data/local/drift/database.dart';
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [todoCategory, todoItem];
}
...
typedef $$TodoItemTableInsertCompanionBuilder = TodoItemCompanion Function({
  Value<int> id,
  required String title,
  required String content,
  Value<int?> category,
...
class $$TodoItemTableTableManager extends RootTableManager<
    ...
    $$TodoItemTableProcessedTableManager,
    $$TodoItemTableInsertCompanionBuilder,
  ...
  $$TodoItemTableTableManager(_$AppDatabase db, $TodoItemTable table)
      : super(TableManagerState(
          ...
          getChildManagerBuilder: (p) =>
              $$TodoItemTableProcessedTableManager(p),
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
...
class $$TodoItemTableProcessedTableManager extends ProcessedTableManager<
    _$AppDatabase,
    $TodoItemTable,
    TodoItemData,
    $$TodoItemTableFilterComposer,
    ...
    $$TodoItemTableInsertCompanionBuilder,
    $$TodoItemTableUpdateCompanionBuilder> {
  $$TodoItemTableProcessedTableManager(super.$state);
}
